  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: isLoading
          ...
          : showtimes.isEmpty
              ? Center(child: Text("Không có lịch chiếu", style: TextStyle(color: Colors.white70)))
              : ListView.builder(
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(cinemaName, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
            SizedBox(height: 8),
            Text("Phòng: $roomName", style: TextStyle(color: Colors.white70)),
            Text("Giờ chiếu: $formattedTime", style: TextStyle(color: Colors.white70)),
            Text("Giá vé: $price", style: TextStyle(color: Colors.orangeAccent, fontWeight: FontWeight.bold)),
            SizedBox(height: 12),
            Align(
